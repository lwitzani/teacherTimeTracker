...
const translations = {
    trackingActive: 'Zeittracking aktiv',
    trackingInactive: 'Zeittracking inaktiv',
    trackingStarted: 'Zeittracking gestartet',
    trackingStopped: 'Zeittracking beendet',
    coversAdded: 'Vertretungen eingetragen',
    canceledLessonsAdded: 'Ausfälle eingetragen',
    startedAt: 'Gestartet um',
    workingHours: 'Arbeitszeit',
    today: 'heute:',
    currentWeek: 'akt. Woche:',
    currentMonth: 'akt. Monat:',
    covers: 'Vertretungen',
    coversAbbreviation: 'Vertretung',
    registeredFor: 'eingetragen für den',
    canceledLessons: 'Ausfälle',
    canceledLessonsAbbreviation: 'Ausf.',
    lessons: 'Unterricht',
    lessonsAbbreviation: 'UE',
    oClock: 'Uhr',
    ...
    lessonsSet: 'Schulstunden wurden eingetragen',
    manuaTrackingDone: 'Zeit wurde eingetragen'
};
